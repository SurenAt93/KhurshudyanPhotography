    ...
    get_right_slide: function(e) {
      ...
      img.fadeOut(420, function() {
        if(self.slider_index < (self.images_count - 1)) {
          self.slider_index++;
          var img_url = 'app/img/commercial/' + self.slider_index + '.jpg';
          requirejs(
          [
            'image!' + img_url,
          ],
          ...
          img.attr('src', 'app/img/commercial/' + (self.images_count - 1) + '.jpg')
            .show();
          $(e.target).hide();
        }
        $('#gallery_preloader').fadeOut(110);
    ...
    get_left_slide: function(e) {
      ...
      img.fadeOut(420, function() {
        if(self.slider_index > 1) {
          ...
          img.attr('src', 'app/img/commercial/' + self.slider_index + '.jpg');
          img.fadeIn(420);
          $('#gallery #right_img').show();
        } else {
          img.attr('src', 'app/img/commercial/' + 1 + '.jpg')
            .show();
          $(e.target).hide();
        }
        $('#gallery_preloader').fadeOut(110);
