...
[
  ...
  'modernizr',
  'toucheffects',
  'require.text!tpl/nature/11.tpl',
],
function($, Backbone, _, Handlebars, Modernizr, Toucheffects, MainTpl) {
  return Backbone.View.extend({
    ...
    load_more_images: function(e) {
      if(this.image_index < 61 ) {
        this.$('.load_more_section').hide();
        this.$('.preloader-anim').show();
        this.images = [];
        for(var i = this.image_index; i < (this.image_index + 10); i++) {
          this.images.push('image!app/img/nature/' + i + '.jpg');
        }
        this.image_index = i;
        var self = this;
        requirejs(
        [
          'require.text!tpl/nature/' + this.image_index + '.tpl'        
        ],
        function(ImagesTpl) {
          ...
          requirejs(
            ...
            function(
              ...
              setTimeout(function() {
                ...
                this.$('.load_more_section.preloader-anim').hide();
              }, 10);
            }
          );
        });
